    ...
    return (
        <div className="card mb-4 custom-card"> {/* Add custom-card class */}
            ...
            <div className="card-body">
                ...
                <p className="card-text custom-description text-start">{shortDescription} <a href={link} className="card-link custom-link">{/* Add custom-link class */}
                    read more
                </a></p> {/* Add custom-description class */}
            </div>
